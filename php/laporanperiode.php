...
if(isset($_POST["cari"])){	
	$mahasiswa = caria($_POST["tanggalawal"],$_POST["tanggalakhir"]);
}
...
<head>
	<title>.:Mutasi:.</title>
	<link rel="stylesheet" type="text/css" href="../css/stylelaporanperiode.css">
</head>
<body>
	<div class="container">
		<div class="header">
		...
		<div class="main">
			<form action="" method="post" enctype="multipart/form-data">
			    ...
			    <div class="print">
			    	<button><a href="cetakperiode.php?tanggalawal=<?=$_POST['tanggalawal'];?>&tanggalakhir=<?=$_POST['tanggalakhir'];?>">Cetak</a></button>
			    </div>
			    <?php } ?>
			</form>
		</div>
