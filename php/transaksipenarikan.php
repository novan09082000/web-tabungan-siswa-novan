					...
					<div class="kartu">
						...
						<div class="isi">
							<div class="data">
								...
								<div class="nama">Nama 			: <input type="text" name="nama" value="<?php echo $mahasiswa[0]['Nama']; ?>" hidden=""><?php echo $mahasiswa[0]["Nama"]; ?> <br></div>
								...
								<div class="masukan">saldo penarikan uang <input type="text" name="masuksaldo"></div>
							</div>
							<div class="foto">
